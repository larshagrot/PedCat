...
/**
 * The Class FrameworkGenericServiceLocator.
 *
 * @param <ServiceType> the generic type
 */
public abstract class FrameworkGenericServiceLocator<ServiceType extends FrameworkService> implements java.io.Serializable {
	...
	/**
	 * Instantiates a new framework generic service locator.
	 */
	protected FrameworkGenericServiceLocator() {
	...
	private static Logger logger = LoggerFactory
			.getLogger(FrameworkGenericServiceLocator.class);
	 ...
	 */
	public abstract ServiceType createLocalService();
	 ...
	 * @return the service type
	 */
	public ServiceType createLocalEjbService() {
	 ...
	 * @return the service type
	 */
	public ServiceType createRemoteEjbService() {
		// TODO Auto-generated method stub
		throw new FrameworkException(
